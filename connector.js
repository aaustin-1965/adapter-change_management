...
class ServiceNowConnector {
  ...
  sendRequest(callOptions, callback) {
    ...
    console.log(`Calling request() with requestOptions '${JSON.stringify(requestOptions)}'`)
  ...
  processRequestResults(error, response, body, callback) {
    ...
    * Check error and response code to make sure response is good.
    */
    if (error) {
      ...
      /*
      * If no errors were found in either the error or status
      * code, we will return the body as a succesful response.
      */
